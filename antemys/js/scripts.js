(function ($) {
  $(document).ready(function () {
    ...
    const phrases = ['energetic', 'cool', 'amazing', 'l33t', 'smart', 'strong', 'fierce', 'unstoppable', 'powerful', 'exciting', 'relentless', 'loving', 'kind', 'beast-mode', 'hardcore', 'intelligent', 'next-level', 'fun', 'free', 'awesome'];
